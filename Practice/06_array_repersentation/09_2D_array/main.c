...
//     A[1] = (int **)malloc(4 * sizeof(int *));
//     A[2] = (int **)malloc(4 * sizeof(int *));
//     A[0][0] = (int *)malloc(5 * sizeof(int));
//     A[0][1] = (int *)malloc(5 * sizeof(int));
//     A[0][2] = (int *)malloc(5 * sizeof(int));
//     A[0][3] = (int *)malloc(5 * sizeof(int));
//     A[1][0] = (int *)malloc(5 * sizeof(int));
//     A[1][1] = (int *)malloc(5 * sizeof(int));
//     A[1][2] = (int *)malloc(5 * sizeof(int));
//     A[1][3] = (int *)malloc(5 * sizeof(int));
//     A[2][0] = (int *)malloc(5 * sizeof(int));
//     A[2][1] = (int *)malloc(5 * sizeof(int));
//     A[2][2] = (int *)malloc(5 * sizeof(int));
//     A[2][3] = (int *)malloc(5 * sizeof(int));
//     // freeing memory
//     for (i = 0; i < 3; i++)
//     {
//         free(A[i]);
